...
export default function Sidebar() {
    ...
    return (
        <aside
            className={`h-full hidden md:flex w-full md:w-64 flex-col font-montserrat border-r border-[#E6E8F5] relative transition-all duration-300 ${
                darkMode ? 'bg-gray-900 text-white' : 'bg-[#F5F6FF] text-black'
            }`}
        >
            {/* Logo */}
