...
export default function Topbar({ user, onSidebarToggle }) {
  ...
  return (
    <header className={`flex items-center justify-end md:justify-between px-4 md:px-8 h-16 md:h-20 border-b transition-colors duration-300 font-montserrat ${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'}`}>
