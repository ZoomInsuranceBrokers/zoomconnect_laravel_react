        ...
        <EmployeeLayout user={employee}>
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 p-2 my-4 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl shadow-sm">
                <div className="max-w-7xl mx-auto">
                    {/* Header */}
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-3 sm:p-4 md:p-6 mb-3 sm:mb-4 md:mb-6 border-b-2 border-gray-200">
                        <h1 className="text-xl sm:text-2xl md:text-2xl font-bold text-gray-800">Help & Support</h1>
                        <p className="text-gray-600 text-[10px] sm:text-xs md:text-xs mt-1">We're here to assist you!</p>
                    </div>

                    {/* Tabs */}
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm mb-3 sm:mb-4 md:mb-6 p-1.5 sm:p-2 border-b-2 border-gray-200">
                        <div className="flex space-x-1 sm:space-x-2">
                            <button
                                onClick={() => setActiveTab('faq')}
                                className={`flex-1 flex items-center justify-center space-x-1 sm:space-x-2 py-2 sm:py-3 px-2 sm:px-4 rounded-lg sm:rounded-xl transition-all text-[10px] sm:text-xs md:text-sm font-medium ${activeTab === 'faq'
                            ...
                            <button
                                ...
                                className={`flex-1 flex items-center justify-center space-x-1 sm:space-x-2 py-2 sm:py-3 px-2 sm:px-4 rounded-lg sm:rounded-xl transition-all text-[10px] sm:text-xs md:text-sm font-medium ${activeTab === 'tickets'
                                    ? 'bg-[rgb(147,71,144)] text-white shadow-md'
                                    : 'text-gray-600 hover:bg-gray-50'
                                    }`}
                            >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
                            ...
                            <div className="lg:col-span-3">
                                <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-3 sm:p-4 md:p-6 border border-gray-200">
                                    <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4 md:mb-6 pb-3 sm:pb-4 border-b-2 border-gray-100">
                                ...
                                <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-3 sm:p-4 md:p-6 border border-gray-200">
                                    ...
                                    <div className="space-y-2 sm:space-y-3 md:space-y-4">
                                        ...
                                        <div className="bg-gray-50 rounded-lg sm:rounded-xl p-2.5 sm:p-3 md:p-4 border border-gray-200">
                                            <div className="flex items-start space-x-2 sm:space-x-3">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-gray-600 text-[10px] sm:text-xs md:text-sm leading-tight">123 Business Park<br />Suite 100<br />New York, NY 10001</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border border-purple-200 text-center">
                                            ...
                                            <button
                                                onClick={openChatbot}
                                                className="w-full bg-gradient-to-r from-purple-400 to-pink-400 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl font-medium text-[10px] sm:text-xs md:text-sm hover:from-purple-500 hover:to-pink-500 transition-all shadow-md"
                                            >
            ...
            <button
                onClick={openChatbot}
                className="fixed bottom-24 right-4 sm:bottom-6 sm:right-6 w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full shadow-2xl flex items-center justify-center hover:from-purple-500 hover:to-pink-500 transition-all hover:scale-110 z-50 group"
                aria-label="Open AI Chatbot"
            >
                <SparklesIcon className="w-8 h-8 sm:w-8 sm:h-8 text-white" />
            ...
            {showChatbot && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center p-3 sm:p-4 z-50">
                    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-sm sm:max-w-2xl h-[90vh] sm:h-[600px] flex flex-col">
                        {/* Header */}
                        <div className="bg-gradient-to-r from-purple-400 to-pink-400 p-3 sm:p-5 rounded-t-2xl sm:rounded-t-3xl flex justify-between items-center flex-shrink-0">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {chatbotMessages.map((msg, index) => (
                                    <div key={index} className={`flex ${msg.sender_type === 'user' ? 'justify-end' : 'justify-start'}`}>
                                        <div className={`max-w-[85%] sm:max-w-[80%] ${msg.sender_type === 'user'
                                                ...
                                                <div className="mt-2 sm:mt-3 space-y-1.5 sm:space-y-2">
                                                    {msg.options.map((option) => (
                                                        <button
                                                            ...
                                                            disabled={loading}
                                                            className="w-full text-left bg-gradient-to-r from-purple-400 to-pink-400 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-[10px] sm:text-xs md:text-sm font-medium hover:from-purple-500 hover:to-pink-500 transition-all disabled:opacity-50 shadow-md"
                                                        >
                                                            {option.label}
                                                        </button>
                                                    ))}
