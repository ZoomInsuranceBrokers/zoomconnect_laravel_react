...
function LogoCarousel() {
    ...
    const trustedLogos = [
        { name: 'Paytm', logo: '/assets/images/solutions/startups_logo/paytm.png' },
        { name: 'Pramerica', logo: '/assets/images/solutions/startups_logo/Pramerica.png' },
        { name: 'PROVANA INDIA PRIVATE LIMITED', logo: '/assets/images/solutions/startups_logo/Provana.png' },
        { name: 'Eastman', logo: '/assets/images/solutions/startups_logo/eastman.png' },
        { name: 'Nobroker', logo: '/assets/images/solutions/startups_logo/No broker.png' }
    ];
            ...
            <div className="min-h-screen flex flex-col items-center justify-center font-montserrat relative overflow-x-hidden bg-[#ffceea78] text-gray-900 ">
                ...
                <section className="w-full relative pt-20 pb-10 lg:py-28">
                    ...
                    <div className="max-w-7xl z-10 mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h1 className="text-2xl md:text-3xl lg:text-5xl font-extrabold font-dmserif leading-tight mb-2 md:mb-6">
                                Benefits & Insurance Solutions for <span className="text-[#FF0066] ">Large Enterprises</span>
                            </h1>

                            <p className="text-xs md:text-base text-gray-600 mb-4 md:mb-8 max-w-xl">
                        ...
                        <div className="relative">
                            <div className="">
                                <img src="/assets/images/solutions/large_enterprises _image.png" alt="Team meeting" className="w-full md:h-[450px] h-[260px] object-contain" />
                            </div>
                        </div>
                    </div>
                </section>
                <section className="w-full py-8 md:py-12 bg-[#3d1139] text-white">
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="text-center mb-5">
                            ...
                            <div className="text-xs md:text-base text-white/80 md:font-medium mb-2 ">Empowering large teams to drive enterprise success</div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="text-center mb-10 md:mb-20">
                            <h2 className="text-xl md:text-5xl font-dmserif font-semibold mb-4 text-gray-800">
                                Why Choose ZoomConnect for Your Large Business?
                            </h2>
                            <p className="text-xs md:text-base text-gray-700 font-medium mb-6 max-w-2xl mx-auto">
                                Give your team enterprise-grade insurance and wellness benefits—designed to be scalable, flexible, and effortless for large enterprises.
                            </p>
                        </div>
                ...
                <section className="w-full py-8 md:py-24 bg-white flex flex-col items-center justify-center relative overflow-hidden">
                    ...
                    <span className="absolute bottom-[20%] left-10 md:left-[45%] text-[#FF0066] text-3xl md:text-5xl" style={{ transform: 'rotate(-7deg)' }}>📈</span>
