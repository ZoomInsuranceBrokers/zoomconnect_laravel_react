	...
	<footer className='relative w-full text-white bg-[#571754]'>
		...
		<div className='relative z-10 mx-auto w-full px-6 md:pt-16 lg:px-12'>
			<div className='grid gap-10 lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:items-start'>
				<div className='w-[100%] md:w-[80%] max-w-2xl lg:max-w-none  flex flex-col items-center lg:items-start text-center lg:text-left'>
					...
					<div className='mt-6 flex flex-row gap-6 items-center'>
						...
						<div className='flex justify-center max-w-[100px]'>
							<img
								src='/assets/logo/QR zoom connect-01.png'
						...
						<div className='flex flex-row gap-3'>
							...
							>
								<img
									src='/assets/logo/google play-01 1.png'
									alt='Get it on Google Play'
									className='h-8 w-auto object-contain'
								/>
								<img
									src='/assets/logo/app store-01 1.png'
				...
				<div
					className='hidden self-stretch lg:flex lg:justify-center lg:px-10'
					aria-hidden='true'
				>
					<div
						...
						style={{
							background:
								'linear-gradient(180deg, rgba(255,255,255,0.05), rgba(255,255,255,0.25), rgba(255,255,255,0.05))',
						}}
					></div>
				</div>
			...
			<div className='mt-4 w-full flex justify-center'>
				<img
					src='/assets/logo/ZOOMCONNECT WITH PEOPLE-02.png'
			...
			<div className='mt-2 flex flex-col gap-6 text-xs text-white/45 md:flex-col md:justify-between md:items-center'>
				<div className='leading-relaxed space-y-1 max-w-full text-center md:text-center'>
					<p>
						...
						D-104, Udyog Vihar Phase V, Sector-19, Gurugram, Haryana-122016. CIN:
						U66000HR2008PTC065899.
					</p>
					<p>
						<span className='font-semibold text-white/70'>
							IRDAI Licence No.: 389.
						</span>{' '}
						Licence Category: Composite. Licence Expiry: 1st January 2027.
					</p>
					<p>
