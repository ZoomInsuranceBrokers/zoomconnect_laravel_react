            ...
            <div className="min-h-screen flex flex-col items-center justify-center font-montserrat relative overflow-x-hidden bg-[#ffceea78] text-gray-900">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[500px]">
                            ...
                            <div className="flex justify-center items-center h-full">
                                <div className="w-full max-w-md relative h-96">
                                    ...
                                    <div className="absolute -top-20 left-1/4 w-80 h-80 bg-gradient-to-br from-cyan-200/30 to-transparent rounded-full blur-3xl"></div>
                                    <div className="absolute -bottom-20 right-1/4 w-80 h-80 bg-gradient-to-tl from-[#FF0066]/20 to-transparent rounded-full blur-3xl"></div>
                ...
                <section className="w-full py-16 bg-transparent">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-dmserif font-bold text-gray-800 mb-3">Explore Our Versatile Question Types</h2>
                            <p className="text-gray-600 max-w-2xl mx-auto text-xs md:text-base">Select from a variety of question formats to capture meaningful feedback and actionable insights.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Text (Open-ended) */}
                            {/* Text (Open-ended) - Top Left */}
                            <div className="relative bg-white rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-none rounded-bl-none shadow-2xl p-8 flex flex-col items-center text-center min-h-[260px] overflow-hidden group max-w-[340px] w-full mx-auto">
                                {/* Quarter circle accent */}
                                <div className="absolute bottom-0 right-0 w-20 h-20 bg-[#934790] rounded-br-[2rem] rounded-tl-none rounded-bl-none rounded-tr-none z-0"></div>
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-14 h-14 flex items-center justify-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#934790]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                                    </div>
                                    <h4 className="font-bold text-xl text-gray-900 mb-1">Text</h4>
                                    <p className="text-xs text-gray-500 font-medium mb-2">Open-ended</p>
                                    <p className="text-base text-gray-600 leading-relaxed">Collect detailed feedback, comments, and qualitative insights from respondents with unlimited flexibility.</p>
                                </div>
                            </div>
                            ...
                            <div className="relative bg-white rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-none rounded-bl-none shadow-2xl p-8 flex flex-col items-center text-center min-h-[260px] overflow-hidden group max-w-[340px] w-full mx-auto">
                                {/* Quarter circle accent */}
                                <div className="absolute bottom-0 left-0 w-20 h-20 bg-[#FFB300] rounded-bl-[2rem] rounded-tl-none rounded-br-none rounded-tr-none z-0"></div>
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-14 h-14 flex items-center justify-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#FFB300]" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="8" strokeWidth="2" /></svg>
                                    </div>
                                    <h4 className="font-bold text-xl text-gray-900 mb-1">Single-select</h4>
                                    <p className="text-xs text-gray-500 font-medium mb-2">Radio buttons</p>
                                    <p className="text-base text-gray-600 leading-relaxed">Allow respondents to choose one answer from multiple options using radio buttons.</p>
                                </div>
                            </div>
                            ...
                            <div className="relative bg-white rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-none rounded-bl-none shadow-2xl p-8 flex flex-col items-center text-center min-h-[260px] overflow-hidden group max-w-[340px] w-full mx-auto">
                                {/* Quarter circle accent */}
                                <div className="absolute top-0 right-0 w-20 h-20 bg-[#0ea5a4] rounded-tr-[2rem] rounded-tl-none rounded-br-none rounded-bl-none z-0"></div>
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-14 h-14 flex items-center justify-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#0ea5a4]" viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="4" width="7" height="7" strokeWidth="2" /><rect x="13" y="4" width="7" height="7" strokeWidth="2" /><rect x="4" y="13" width="7" height="7" strokeWidth="2" /></svg>
                                    </div>
                                    <h4 className="font-bold text-xl text-gray-900 mb-1">Multi-select</h4>
                                    <p className="text-xs text-gray-500 font-medium mb-2">Checkboxes</p>
                                    <p className="text-base text-gray-600 leading-relaxed">Enable respondents to select multiple answers using checkboxes for comprehensive feedback.</p>
                                </div>
                            </div>
                            ...
                            <div className="relative bg-white rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-none rounded-bl-none shadow-2xl p-8 flex flex-col items-center text-center min-h-[260px] overflow-hidden group max-w-[340px] w-full mx-auto">
                                {/* Quarter circle accent */}
                                <div className="absolute top-0 left-0 w-20 h-20 bg-[#FFD966] rounded-tl-[2rem] rounded-tr-none rounded-br-none rounded-bl-none z-0"></div>
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-14 h-14 flex items-center justify-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#FFD966]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>
                                    </div>
                                    <h4 className="font-bold text-xl text-gray-900 mb-1">Rating Scale</h4>
                                    <p className="text-xs text-gray-500 font-medium mb-2">Stars & numbers</p>
                                    <p className="text-base text-gray-600 leading-relaxed">Collect satisfaction ratings with intuitive star or numeric scales for easy evaluation.</p>
                                </div>
                            </div>
                        </div>
                    </div>
