...
export default function EditEntity({ company, entity }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('corporate.entity.update', [company.comp_id, entity.id]), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <SuperAdminLayout>
            <Head title={`Edit Entity - ${entity?.branch_name || 'Entity'}`} />

            <div className="p-4 max-w-3xl mx-auto">
                <div className="flex items-center justify-between mb-4">
                    <h1 className="text-lg font-semibold text-gray-800">Edit Entity</h1>
                    <Link
                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full mt-1 px-2 py-1.5 border border-gray-300 rounded-md shadow-sm text-sm bg-gray-100 cursor-not-allowed"
                            disabled
                            readOnly
                        />
                    </div>
