                        ...
                        >
                            {currentItems.map((company) => (
                                ...
                                >
                                    ...
                                    <td className="px-3 py-2 whitespace-nowrap">
                                        {company.corporate_label ? (
                                            <span className="inline-flex px-2 py-1 text-[9px] font-semibold rounded bg-blue-100 text-blue-800">
                                    ...
                                    <td className="px-3 py-2 whitespace-nowrap">
                                        {company.corporate_group ? (
                                            <span className="inline-flex px-2 py-1 text-[9px] font-semibold rounded bg-green-100 text-green-800">
                                                {
                                                    company.corporate_group
                                                        .group_name
                                                }
