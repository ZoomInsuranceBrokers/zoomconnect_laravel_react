...
export default function Step1AddDependents({
    ...
    if (dependents.some(d => d.relation === "SELF")) {
        ...
        // Hide self card in edit mode
        displayDependents = isEdit ? others : [selfMember, ...others];
    }
