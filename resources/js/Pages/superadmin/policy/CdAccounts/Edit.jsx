...
export default function Edit({ cdAccount, companies = [], insurers = [] }) {
    ...
    return (
        <SuperAdminLayout>
            ...
            <div className="max-w-6xl mx-auto py-8">
                ...
                {/* Section Heading */}
                <h2 className="text-xl font-bold mb-2">Edit CD Account Details</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                value={companyOptions.find(opt => opt.value === data.comp_id) || null}
                                onChange={opt => setData("comp_id", opt ? opt.value : "")}
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                value={insurerOptions.find(opt => opt.value === data.ins_id) || null}
                                onChange={opt => setData("ins_id", opt ? opt.value : "")}
