...
export default function Edit({ insurance }) {
    ...
    const { data, setData, post, processing } = useForm({
        ...
        state_name: insurance.state_name || "",
        city_name: insurance.city_name || "",
        pincode: insurance.pincode || "",
        icon: null,
        icon_url: insurance.insurance_comp_icon_url ? `/${insurance.insurance_comp_icon_url}` : "",
        _method: 'PUT',
    });
    ...
    return (
        <SuperAdminLayout>
            <Head title="Edit Insurance Company" />
            <div className="w-full py-6 px-4">
                <h2 className="text-xl font-bold mb-4">Edit Insurance Company</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <form
                            onSubmit={e => {
                                e.preventDefault();
                                if (!validate()) return;
                                post(route("superadmin.policy.insurance.update", insurance.id));
                            }}
                        ...
                        >
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-center gap-2">
                                ...
                                <span className="text-xs text-blue-900">
                                    Please update correct insurance company details.
                                </span>
                            </div>
                            ...
                            <div className="pt-4 pb-2 flex gap-3">
                                ...
                                >
                                    {processing ? "Updating..." : "Update Insurance Company"}
                                </button>
                    ...
                    <div className="bg-gradient-to-b from-[#faf5ff] to-white shadow-md border border-[#ecd9f1] rounded-2xl p-6">
                        ...
                        <ul className="text-sm text-gray-700 space-y-3">
                            <li>• Update the <b>insurance company name</b> if needed.</li>
