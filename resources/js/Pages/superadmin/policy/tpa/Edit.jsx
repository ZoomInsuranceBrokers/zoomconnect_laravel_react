...
export default function Edit({ tpa }) {
    const { errors } = usePage().props;
    const [lookingUpPincode, setLookingUpPincode] = useState(false);

    const { data, setData, post, processing } = useForm({
        tpa_company_name: tpa.tpa_company_name || "",
        address: tpa.address || "",
        state_name: tpa.state_name || "",
        city_name: tpa.city_name || "",
        pincode: tpa.pincode || "",
        tpa_table_name: tpa.tpa_table_name || "",
        status: tpa.status !== undefined ? tpa.status : 1,
        icon: null,
        icon_url: tpa.tpa_comp_icon_url ? `/${tpa.tpa_comp_icon_url}` : "",
        _method: 'PUT',
    });
    ...
    return (
        <SuperAdminLayout>
            <Head title="Edit TPA Company" />
            <div className="w-full py-6 px-4">
                <h2 className="text-xl font-bold mb-4">Edit TPA Company</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <form
                            onSubmit={e => {
                                e.preventDefault();
                                if (!validate()) return;
                                post(route("superadmin.policy.tpa.update", tpa.id));
                            }}
                        ...
                        >
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-center gap-2">
                                ...
                                <span className="text-xs text-blue-900">
                                    Please update correct TPA details.
                                </span>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    {data.icon_url ? "Change Icon" : "Choose Icon"}
                                </button>
                            ...
                            <div className="pt-4 pb-2 flex gap-3">
                                ...
                                >
                                    {processing ? "Updating..." : "Update TPA Company"}
                                </button>
                    ...
                    <div className="bg-gradient-to-b from-[#faf5ff] to-white shadow-md border border-[#ecd9f1] rounded-2xl p-6">
                        ...
                        <ul className="text-sm text-gray-700 space-y-3">
                            <li>• Update the official <b>TPA company name</b> if needed.</li>
                            <li>• Make sure the <b>address</b> is complete.</li>
                            <li>• Pincode will <b>auto-fill city & state</b>.</li>
                            <li>• Upload a new <b>company icon</b> if required.</li>
