...
export default function CreateEnrollment({ companies, messageTemplates }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        twin_allowed: false,
        is_self_allowed_by_default: true,
        grade_exclude: [],
    ...
    const handleSubmit = (e) => {
        ...
        post(route('superadmin.policy.enrollment-lists.store'), formData, {
            onSuccess: () => {
                // Redirect to enrollment list with success message
                router.visit(route('superadmin.policy.enrollment-lists.index'), {
                    method: 'get',
                    data: {
                        message: `Enrollment "${data.enrolment_name}" created successfully!`,
                        messageType: 'success'
                    }
                });
            },
                                                ...
                                                <input
                                                    ...
                                                    onKeyPress={(e) => {
                                                        if (e.key === 'Enter') {
                                                            ...
                                                            if (trimmedValue && !data.grade_exclude.includes(trimmedValue)) {
                                                                setData('grade_exclude', [...data.grade_exclude, trimmedValue]);
                                                                setGradeInputValue('');
                                                            }
                                                        }
                                                    }}
