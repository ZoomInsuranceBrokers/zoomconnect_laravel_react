    ...
    return (
        <CompanyUserLayout user={user}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Total Policies</p>
                            <p className="text-2xl sm:text-3xl font-light text-gray-900">{stats?.total_policies || 0}</p>
                        ...
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                            <FiShield className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Covered Members</p>
                            <p className="text-2xl sm:text-3xl font-light text-gray-900">{stats?.total_members || 0}</p>
                        ...
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                            <FiUsers className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Active Endorsements</p>
                            <p className="text-2xl sm:text-3xl font-light text-gray-900">{stats?.active_endorsements || 0}</p>
                            <p className="text-xs text-purple-600 flex items-center gap-1 mt-1">
                                <FiCheckCircle className="w-3 h-3" />
                                Completed
                            </p>
                        </div>
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-teal-500 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                            <FiFileText className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-10 gap-4 sm:gap-6">
                ...
                <div className="lg:col-span-7">
                    {/* Search Bar */}
                    <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-3 sm:mb-4 shadow-sm">
                        <div className="flex flex-col gap-2 sm:gap-3 items-stretch sm:items-center sm:justify-between">
                            <div className="flex-1 relative w-full">
                                <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                                <input
                                    type="text"
                                    placeholder="Search policies..."
                                    className="w-full pl-9 pr-4 py-2.5 sm:py-2 text-xs border border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-purple-200 focus:border-purple-400 bg-white"
                                    value={searchTerm}
                                    onChange={(e) => setSearchTerm(e.target.value)}
                                />
                            </div>
                            <div className="flex gap-2 justify-stretch sm:justify-end w-full">
                                <button 
                                    onClick={() => setShowFilterModal(true)}
                                    className="flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 flex-1 sm:flex-none px-2.5 sm:px-3 py-2.5 sm:py-2 text-xs font-medium border border-gray-200 rounded-lg sm:rounded-xl hover:bg-gray-50 bg-white transition-all relative whitespace-nowrap"
                                >
                                ...
                                <button className="flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 flex-1 sm:flex-none px-2.5 sm:px-3 py-2.5 sm:py-2 text-xs font-medium bg-[#2d2d2d] text-white rounded-lg sm:rounded-xl hover:bg-[#1f1f1f] transition-all whitespace-nowrap">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full min-w-[600px]">
                                <thead className="bg-gray-50/80 border-b border-gray-200">
                                    <tr>
                                        <th className="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[9px] sm:text-[10px] font-bold text-gray-600 uppercase tracking-wider">Policy Details</th>
                                        <th className="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[9px] sm:text-[10px] font-bold text-gray-600 uppercase tracking-wider">Insurance / TPA</th>
                                        <th className="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[9px] sm:text-[10px] font-bold text-gray-600 uppercase tracking-wider">Validity</th>
                                        <th className="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[9px] sm:text-[10px] font-bold text-gray-600 uppercase tracking-wider">Status</th>
                                        <th className="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[9px] sm:text-[10px] font-bold text-gray-600 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                    ...
                                    {filteredPolicies.length > 0 ? (
                                            ...
                                            return (
                                                ...
                                                >
                                                        ...
                                                        <div className="flex items-center gap-2 sm:gap-3">
                                                            ...
                                                            <div className="min-w-0">
                                                                ...
                                                                <div className="flex items-center gap-1.5 sm:gap-2 mt-0.5 flex-wrap">
                                                                    ...
                                                                    <span className={`px-1.5 sm:px-2 py-0.5 rounded-full text-[8px] sm:text-[9px] font-semibold ${getPolicyTypeColor(policy.policy_type)}`}>
                                                    ...
                                                    <td className="px-3 sm:px-4 py-2.5 sm:py-3">
                                                        ...
                                                        <div className="text-[9px] text-gray-500 mt-0.5">{policy.tpa_name || 'N/A'}</div>
                                                    </td>
                                                    <td className="px-3 sm:px-4 py-2.5 sm:py-3">
                                                        <div className="text-xs text-gray-900">{formatDate(policy.policy_start_date)}</div>
                                                        <div className="text-[9px] text-gray-500 mt-0.5">to {formatDate(policy.policy_end_date)}</div>
                                                        {daysLeft <= 90 && daysLeft > 0 && (
                                                            <div className="text-[9px] text-orange-600 font-medium mt-1">
                                                                {daysLeft} days left
                                                            </div>
                                                        )}
                                                    </td>
                                                    <td className="px-3 sm:px-4 py-2.5 sm:py-3">
                                                        <span className="px-2.5 sm:px-3 py-1 text-[9px] sm:text-[10px] font-semibold rounded-full bg-green-100 text-green-800 flex items-center gap-1 w-fit whitespace-nowrap">
                                                            <FiCheckCircle className="w-3 h-3" />
                                                    ...
                                                    <td className="px-3 sm:px-4 py-2.5 sm:py-3">
                                                        <div className="flex items-center gap-1.5 sm:gap-2">
                                                            <Link
                                                                ...
                                                                className="p-1.5 sm:p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all flex-shrink-0"
                                                                title="View Details"
                                                            >
                                                            ...
                                                            <Link
                                                                ...
                                                                onClick={(e) => e.stopPropagation()}
                                                                className="p-1.5 sm:p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all flex-shrink-0"
                                        ...
                                        <tr>
                                            <td colSpan="5" className="px-3 sm:px-4 py-8 sm:py-12 text-center">
                                                <FiAlertCircle className="w-8 sm:w-10 h-8 sm:h-10 text-gray-400 mx-auto mb-2 sm:mb-3" />
                ...
                <div className="lg:col-span-3 space-y-3 sm:space-y-4">
                    ...
                    {selectedPolicy ? (
                        <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm">
                            <h3 className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-3 sm:mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-0 sm:pt-2 border-t border-gray-100">
                                    <div className="text-[10px] text-gray-500 mb-1 uppercase tracking-wider">Policy Number</div>
                                    <div className="text-xs sm:text-sm font-medium text-gray-900">{selectedPolicy.policy_number}</div>
                                </div>
                                
                                <div className="pt-0 sm:pt-2 border-t border-gray-100">
                                    <div className="text-[10px] text-gray-500 mb-1 uppercase tracking-wider">Insurance Company</div>
                                    <div className="text-xs sm:text-sm font-medium text-gray-900">{selectedPolicy.insurance_company_name}</div>
                                </div>

                                <div className="pt-0 sm:pt-2 border-t border-gray-100">
                                    <div className="text-[10px] text-gray-500 mb-1 uppercase tracking-wider">TPA</div>
                                    <div className="text-xs sm:text-sm font-medium text-gray-900">{selectedPolicy.tpa_name || 'N/A'}</div>
                                </div>
                                ...
                                <div className="pt-0 sm:pt-2 border-t border-gray-100 grid grid-cols-2 gap-3">
                                    <Link
                        ...
                        <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-8 shadow-sm text-center">
                    ...
                    {/* Quick Stats */}
                    <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm">
                        <h3 className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-3 sm:mb-4">Overview</h3>
