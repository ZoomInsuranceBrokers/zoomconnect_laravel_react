// Dummy Enrollments Data for Testing
// Use this data structure when passing props to the Enrollments component

export const dummyEnrollmentsData = {
    user: {
        id: 1,
        name: 'Admin User',
...
// Usage in your Laravel route:
// Route::get('/company-user/enrollments', function () {
//     return Inertia::render('CompanyUser/Enrollments', dummyEnrollmentsData);
// });
